country_start =["Italy","France","Germany","Spain","Portugal","Switzerland","Belgium","Netherlands"]
...
european_cities = {
    ...
    "Germany": ["Berlin", "Munich", "Hamburg", "Cologne","Frankfurt","Stuttgart","Nuremberg","Liepzig","Dusseldorf"],
...
night_jets = {
    ...
    "Italy": ["Florence", "Rome", "Verona", "Lake Garda", "Milan", "Venice", "Bologna", "Genoa", "La Spezia & Cinque Terre"],
    "Belgium": ["Brussels"],
